   ...
   <footer 
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-b border-gray-600 mb-6">
          <div className="flex flex-col md:flex-row justify-between items-stretch gap-6">
            {/* First Column - Description Text (Left Aligned) */}
            <div className="flex-1 max-w-2xl py-6">
              <p className="text-gray-300 text-sm leading-relaxed text-left">
                Traditional tools stop at data extraction. AuditUp goes further—it explains <br/> its reasoning, 
                flags risks automatically, enables in-doc collaboration, and <br/> exports audit-ready reports 
            ...
            <div className="flex border-l border-gray-600">
              {/* WhatsApp */}
              <div className="flex items-center justify-center border-r border-gray-600 w-24">
